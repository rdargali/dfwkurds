...
export function MissionSection() {
  ...
  const pillars = [
    ...
    },
    {
      ...
      title: { en: 'Event Coordination', ckb: 'ڕێکخستنی چالاکییەکان', kmr: 'Koordînasyona Bûyeran' },
      description: {
        en: 'Planning and hosting community gatherings that celebrate our heritage and build relationships.',
        ckb: 'پلاندانان و میوانداریی کۆبوونەوە کۆمەڵایەتییەکان کە پیرۆزبایی لە میراتی ئێمە دەکەن و پەیوەندییەکان دروست دەکەن.',
        kmr: 'Plansazkirin û mêvandariya kombûnên civakî yên ku pîrozbahiyê li mîrasa me dikin û têkilîyan ava dikin.',
      },
      color: 'kurd-gold',
    },
    {
